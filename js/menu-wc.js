...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">beequalite documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-b9471785b4413cfb5fa1d95958602008"' : 'data-target="#xs-components-links-module-AppModule-b9471785b4413cfb5fa1d95958602008"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-b9471785b4413cfb5fa1d95958602008"' :
                                            'id="xs-components-links-module-AppModule-b9471785b4413cfb5fa1d95958602008"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ContatosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ContatosComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/InspireComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">InspireComponent</a>
                                            </li>
                                            <li class="link">
